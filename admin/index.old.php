...
<div class="flex-grow text-gray-800">
        ...
        <div class="flex flex-shrink-0 items-center ml-auto">
            <button class="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
                ...
                <span class="hidden md:flex md:flex-col md:items-end md:leading-tight">
                    <span class="font-semibold"><?= $_SESSION['adminName'] ?></span>
            ...
            <div class="border-l pl-3 ml-3 space-x-1">
                <button id="btn_logout"
                    ...
                    <span class="sr-only">Log out</span>退出
                    <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <main class="p-6 sm:p-10 space-y-6">
        <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
            <div class="mr-6">
                <h1 class="text-4xl font-semibold mb-2">主页</h1>
            </div>
        ...
        <section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    <span class="block text-2xl font-bold"><?= $db->getNrOfAdmittedUsers() ?></span>
                    <span class="block text-gray-500">学生数量</span>
                </div>
            </div>
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    <span class="block text-2xl font-bold"><?= $db->getNrOfUnauditedUsers() ?></span>
                    <span class="block text-gray-500">待审核</span>
                </div>
            </div>
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                <div class="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-red-600 bg-red-100 rounded-full mr-6">
                ...
                <div>
                    <span class="inline-block text-2xl font-bold"><?= $db->getNrOfArticles() ?></span>
                    <span class="block text-gray-500">文章数量</span>
                </div>
            </div>
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    <span class="block text-2xl font-bold"><?= $db->getNrOfMessages() ?></span>
                    <span class="block text-gray-500">留言数量</span>
                </div>
            </div>
        </section>
    </main>
